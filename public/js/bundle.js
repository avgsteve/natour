...
var displayMap = function displayMap(locations) {
  ...
  */
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXZnc3RldmUiLCJhIjoiY2tjM2Y0cXBvMmN5bDM0bXh5bmFxbjBrMiJ9.1foja_AwKRS0p_Xrn-zX1g'; // creating new tokens for different project: https://account.mapbox.com/access-tokens
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false //// to make map static (can't be dragged. Will look like a photo on page)
    // interactive: false
  ...
  var bounds = new mapboxgl.LngLatBounds(); // new .LngLatBounds obj will be worked with the code: bounds.extend(singleLocation.coordinates); to set bound (display area) for all given coordinates
  ...
  locations.forEach(function (singleLocation) {
    ...
    nodeElement.className = 'marker'; // make new marker Obj.  ref: Markers and controls
    // https://docs.mapbox.com/mapbox-gl-js/api/markers/

    new mapboxgl.Marker({
      element: nodeElement,
      //Set the bottom of the pin as the exact geolocation (like an anchor)
      anchor: 'bottom' // ref: https://docs.mapbox.com/help/tutorials/custom-markers-gl-js/#add-markers-to-the-map

    }) // (chainable methods)
    // THEN set the coordinates (which is read from each location item from "locations" Array) for the marker
    .setLngLat(singleLocation.coordinates) //Then add (attach) the marker object to map obj
    ...
    new mapboxgl.Popup( //object for options
    {
      // property "offset" : To adjust position off-set for popup caption. Value can be Number or Array [x,y]
      offset: 50 // other properties:  https://docs.mapbox.com/mapbox-gl-js/api/markers/#popup-parameters

    }).setLngLat(singleLocation.coordinates) //The caption content (as HTML code)
    .setHTML("<p>Day ".concat(singleLocation.day, ":  ").concat(singleLocation.description, "</p>")).addTo(map); // === Setting map boundary by using bounds.extend: ===
    ...
    bounds.extend(singleLocation.coordinates); // End of locations.forEach(singleLocation => {
  ...
  map.fitBounds(bounds, //Create paddings for the marker displayed on map by passing in an "padding" obj as argument. ref: https://docs.mapbox.com/mapbox-gl-js/api/properties/#paddingoptions-example
  {
    padding: {
      //units: px
      top: 300,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(result.data.token); // === Redirect page after log in is successful ===
            //
          ...
          case 12:
            ...
            console.log(_context.t0.response.data); // console.log(error.response.data.message); //  "Incorrect email or password"
            // display error message with alert popup

            (0, _alerts.showAlert)("error", _context.t0.response.data.message); //end of try/catch block
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/axios-debug-log/node_modules/ms/index.js":[function(require,module,exports) {
/**
 * Helpers.
 */
...
},{}],"../../node_modules/axios-debug-log/node_modules/debug/src/common.js":[function(require,module,exports) {
...
},{"ms":"../../node_modules/axios-debug-log/node_modules/ms/index.js"}],"../../node_modules/axios-debug-log/node_modules/debug/src/browser.js":[function(require,module,exports) {
var process = require("process");
/* eslint-env browser */
...
},{"./common":"../../node_modules/axios-debug-log/node_modules/debug/src/common.js","process":"../../node_modules/process/browser.js"}],"../../node_modules/axios-debug-log/index.js":[function(require,module,exports) {
'use strict'
...
},{"axios":"../../node_modules/axios/index.js","axios/lib/helpers/isAbsoluteURL":"../../node_modules/axios/lib/helpers/isAbsoluteURL.js","axios/lib/helpers/buildURL":"../../node_modules/axios/lib/helpers/buildURL.js","axios/lib/helpers/combineURLs":"../../node_modules/axios/lib/helpers/combineURLs.js","debug":"../../node_modules/axios-debug-log/node_modules/debug/src/browser.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
require('axios-debug-log')({
  request: function request(debug, config) {
    debug('Request with ' + config.headers['content-type']);
  },
  response: function response(debug, _response) {
    debug('Response with ' + _response.headers['content-type'], 'from ' + _response.config.url);
  },
  error: function error(debug, _error) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: urlEndPoint,
              data: dataToUpdate //this PATCH request will rendered as :
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","axios-debug-log":"../../node_modules/axios-debug-log/index.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51H2t20BCkhJwkrSTcuj9BVtugBS9RBWhE9Gt9FKkJpZn07gBQZJTOaAF4AyQikpOc8W5r99Qtu5MxjY28FHI77fF00m1aAdLGm'); // get public key from: https://dashboard.stripe.com/test/apikeys
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            sessionForCheckout = _context.sent;
            // will trigger bookingController.getCheckoutSession
            ...
            console.log(sessionForCheckout); // 2) Create checkout form +charge credit cards
...
var userDataForm = document.querySelector('.form-user-data'); // for updating user's name & email from form class .form-user-data with updateDate()

var userPasswordForm = document.querySelector('.form-user-password'); // for updating user's password & with updateDate()

var bookBtn = document.getElementById('book-tour'); //for #map id
...
if (loginForm) {
  loginForm.addEventListener('submit', function (element) {
    //prevent submit action from reloading page
    element.preventDefault();
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value; //execute login function imported from login.js which can send POST req with axios
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(element) {
      var btnSavePwd, passwordCurrent, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              element.preventDefault(); // Button to be clicked for saving password

              btnSavePwd = document.querySelector('.btn--save-passowrd'); // Fields for inputs for updating password
            ...
            case 14:
              ...
              return (0, _updateSettings.updateSettings)({
                ...
                passwordConfirm: passwordConfirm.value //keys will be parsed into req.body like req.body.passwordConfirm in authController.updatePassword()
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (element) {
    element.target.textContent = 'Processing ...';
    var tourId = element.target.dataset.tourId; //get the Id of the current tour page
    ...
    */
    ...
    (0, _stripe.bookTour)(tourId); // Create session by using function bookTour = async tourId => { ... in stripe.js
  });
} //
//
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13400" + '/');
